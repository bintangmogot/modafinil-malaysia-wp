...
$default_sections = [
    ...
    [
        ...
        'content_en' => 'Contact us via WhatsApp (+60 11-1628 4532) with your order number and tracking details. We will verify your status within 48 hours and process your reshipment or refund to your original bank account within 5-10 business days.',
        'content_ms' => 'Hubungi kami melalui WhatsApp (+60 11-1628 4532) dengan nombor pesanan anda. Kami akan memproses tuntutan dalam masa 2-3 hari bekerja.'
    ]
];
?>
...
<section class="section-padding bg-white">
    <div class="container-custom max-w-3xl space-y-8">
        ...
        <div class="mt-12 bg-emerald-600 text-white rounded-2xl p-8 text-center shadow-lg">
            ...
            <a href="https://wa.me/601116284532" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 bg-white text-emerald-800 font-bold px-7 py-3.5 rounded-full hover:bg-emerald-50 transition-colors shadow-md text-sm">
