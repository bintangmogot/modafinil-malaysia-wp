...
<section class="bg-gradient-to-r from-emerald-700 to-emerald-600 py-16">
    <div class="container-custom max-w-5xl text-center text-white">
        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:justify-center">
            ...
            <a href="https://wa.me/601116284532" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 rounded-full border-2 border-white/60 px-8 py-3.5 text-sm font-bold uppercase tracking-wider text-white transition-all hover:bg-white/10">
