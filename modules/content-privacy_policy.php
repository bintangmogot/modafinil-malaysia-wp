...
<section class="section-padding bg-white">
    <div class="container-custom max-w-3xl space-y-8">
        ...
        <div class="mt-12 bg-slate-900 text-white rounded-2xl p-8 text-center shadow-lg">
            ...
            <a href="https://wa.me/601116284532" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 bg-emerald-600 text-white font-bold px-7 py-3.5 rounded-full hover:bg-emerald-500 transition-colors shadow-md text-sm">
