...
<section class="section-padding bg-stone-50">
    <div class="container-site max-w-4xl">
        ...
        <div class="space-y-8">
            <div class="rounded-xl border border-border bg-card p-7 shadow-card">
                ...
                <p class="mt-4 text-sm font-semibold text-primary-dark"><?= modmy_t("Best for: First-time users who want a trusted, proven brand.", "Terbaik untuk: Pengguna baru yang mahukan jenama terbukti & dipercayai.") ?></p>
            </div>
            ...
            <div class="rounded-xl border border-border bg-card p-7 shadow-card">
                ...
                <p class="mt-4 text-sm font-semibold text-primary-dark"><?= modmy_t("Best for: Budget-conscious buyers or those who want a smoother onset.", "Terbaik untuk: Pembeli yang mementingkan bajet atau mahukan kesan mula yang lebih lancar.") ?></p>
            </div>
            ...
            <div class="rounded-xl border border-border bg-card p-7 shadow-card">
                ...
                <p class="mt-4 text-sm font-semibold text-primary-dark"><?= modmy_t("Best for: Experienced users who need 14+ hours of sustained focus.", "Terbaik untuk: Pengguna berpengalaman yang perlukan fokus berterusan 14+ jam.") ?></p>
            </div>
        </div>
    </div>
</section>
